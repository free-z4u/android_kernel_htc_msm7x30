...
static uint32_t spade_bt_init_table[] = {
	...
	GPIO_CFG(SPADE_GPIO_BT_RESET_N, /* BT_RESET_N */
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
	GPIO_CFG(SPADE_GPIO_BT_SHUTDOWN_N, /* BT_SHUTDOWN_N */
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
...
static uint32_t spade_bt_on_table[] = {
	...
	GPIO_CFG(SPADE_GPIO_BT_CHIP_WAKE,
				...
				GPIO_CFG_4MA),
	/* BT_RESET_N */
	GPIO_CFG(SPADE_GPIO_BT_RESET_N,
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
	/* BT_SHUTDOWN_N */
	GPIO_CFG(SPADE_GPIO_BT_SHUTDOWN_N,
				0,
				GPIO_CFG_OUTPUT,
				GPIO_CFG_NO_PULL,
				GPIO_CFG_4MA),
...
static void spade_config_bt_init(void)
{
	...
	/* BT_RESET_N */
	gpio_set_value(SPADE_GPIO_BT_RESET_N, 0);
	mdelay(1);

	/* BT_SHUTDOWN_N */
	gpio_set_value(SPADE_GPIO_BT_SHUTDOWN_N, 0);
	mdelay(5);

	/* BT_SHUTDOWN_N */
	gpio_set_value(SPADE_GPIO_BT_SHUTDOWN_N, 1);
	mdelay(1);

	/* BT_RESET_N */
	gpio_set_value(SPADE_GPIO_BT_RESET_N, 1);
	mdelay(2);
#if 0
...
static void spade_config_bt_off(void)
{
	...
	/* BT_RTS */
	gpio_set_value(SPADE_GPIO_BT_UART1_RTS, 1);

	/* BT_CTS */

	/* BT_TX */
	gpio_set_value(SPADE_GPIO_BT_UART1_TX, 1);
	...
	/* BT_CHIP_WAKE */
	gpio_set_value(SPADE_GPIO_BT_CHIP_WAKE, 0);
