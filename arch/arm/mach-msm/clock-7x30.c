...
static struct clk_lookup msm_clocks_7x30[ARRAY_SIZE(ownership_map)] = {
	{ .con_id="pll1_clk",		.dev_id="acpu",		.clk=NULL/*{.dbg_name='pll1_clk'}*/},
	{ .con_id="pll2_clk",		.dev_id="acpu",		.clk=NULL/*{.dbg_name='pll2_clk'}*/},
	{ .con_id="pll3_clk",		.dev_id="acpu",		.clk=NULL/*{.dbg_name='pll3_clk'}*/},
	{ .con_id="measure",		.dev_id="debug",	.clk=NULL/*{.dbg_name='measure_clk'}*/},
	{ .con_id="adsp_clk",		.dev_id=NULL,		.clk=NULL/*{.dbg_name='ADSP_CLK'}*/},
	{ .con_id="codec_ssbi_clk",	.dev_id=NULL,		.clk=NULL/*{.dbg_name='CODEC_SSBI_CLK'}*/},
	{ .con_id="ebi1_dcvs_clk",	.dev_id=NULL,		.clk=NULL/*{.dbg_name='EBI1_CLK'}*/},
	{ .con_id="ebi1_fixed_clk",	.dev_id=NULL,		.clk=NULL/*{.dbg_name='EBI1_FIXED_CLK'}*/},
	{ .con_id="ecodec_clk",		.dev_id=NULL,		.clk=NULL/*{.dbg_name='ECODEC_CLK'}*/},
	{ .con_id="core_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='GP_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_serial.2", .clk=NULL/*{.dbg_name='UART3_CLK'}*/},
	{ .con_id="phy_clk",		.dev_id="msm_otg", .clk=NULL/*{.dbg_name='USB_PHY_CLK'}*/},
	{ .con_id="mem_clk",		.dev_id="dtv.0", .clk=NULL/*{.dbg_name='ebi_dtv_clk'}*/},
	{ .con_id="bus_clk",		.dev_id="kgsl-2d0.0", .clk=NULL/*{.dbg_name='ebi_grp_2d_clk'}*/},
	{ .con_id="bus_clk",		.dev_id="kgsl-3d0.0", .clk=NULL/*{.dbg_name='ebi_grp_3d_clk'}*/},
	{ .con_id="mem_clk",		.dev_id="lcdc.0", .clk=NULL/*{.dbg_name='ebi_lcdc_clk'}*/},
	{ .con_id="mem_clk",		.dev_id="mddi.0", .clk=NULL/*{.dbg_name='ebi_mddi_clk'}*/},
	{ .con_id="mem_clk",		.dev_id="tvenc.0", .clk=NULL/*{.dbg_name='ebi_tv_clk'}*/},
	{ .con_id="mem_clk",		.dev_id="msm_vidc.0", .clk=NULL/*{.dbg_name='ebi_vcd_clk'}*/},
	{ .con_id="ebi1_vfe_clk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='ebi_vfe_clk'}*/},
	{ .con_id="mem_clk",		.dev_id="msm_dmov", .clk=NULL/*{.dbg_name='ebi_adm_clk'}*/},
	{ .con_id="core_clk",		.dev_id="kgsl-2d0.0", .clk=NULL/*{.dbg_name='GRP_2D_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="footswitch-pcom.0", .clk=NULL/*{.dbg_name='GRP_2D_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="kgsl-2d0.0", .clk=NULL/*{.dbg_name='GRP_2D_P_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="footswitch-pcom.0", .clk=NULL/*{.dbg_name='GRP_2D_P_CLK'}*/},
	{ .con_id="hdmi_clk",		.dev_id="dtv.0", .clk=NULL/*{.dbg_name='HDMI_CLK'}*/},
	{ .con_id="jpeg_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='JPEG_CLK'}*/},
	{ .con_id="jpeg_pclk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='JPEG_P_CLK'}*/},
	{ .con_id="lpa_codec_clk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='LPA_CODEC_CLK'}*/},
	{ .con_id="lpa_core_clk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='LPA_CORE_CLK'}*/},
	{ .con_id="lpa_pclk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='LPA_P_CLK'}*/},
	{ .con_id="mi2s_m_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='MI2S_M_CLK'}*/},
	{ .con_id="mi2s_s_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='MI2S_S_CLK'}*/},
	{ .con_id="mi2s_codec_rx_m_clk",.dev_id=NULL, .clk=NULL/*{.dbg_name='MI2S_CODEC_RX_M_CLK'}*/},
	{ .con_id="mi2s_codec_rx_s_clk",.dev_id=NULL, .clk=NULL/*{.dbg_name='MI2S_CODEC_RX_S_CLK'}*/},
	{ .con_id="mi2s_codec_tx_m_clk",.dev_id=NULL, .clk=NULL/*{.dbg_name='MI2S_CODEC_TX_M_CLK'}*/},
	{ .con_id="mi2s_codec_tx_s_clk",.dev_id=NULL, .clk=NULL/*{.dbg_name='MI2S_CODEC_TX_S_CLK'}*/},
	{ .con_id="sdac_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='SDAC_CLK'}*/},
	{ .con_id="sdac_m_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='SDAC_M_CLK'}*/},
	{ .con_id="vfe_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='VFE_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="footswitch-pcom.8", .clk=NULL/*{.dbg_name='VFE_CLK'}*/},
	{ .con_id="vfe_camif_clk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='VFE_CAMIF_CLK'}*/},
	{ .con_id="vfe_mdc_clk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='VFE_MDC_CLK'}*/},
	{ .con_id="vfe_pclk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='VFE_P_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="footswitch-pcom.8", .clk=NULL/*{.dbg_name='VFE_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="kgsl-3d0.0", .clk=NULL/*{.dbg_name='GRP_3D_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="footswitch-pcom.2", .clk=NULL/*{.dbg_name='GRP_3D_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="kgsl-3d0.0", .clk=NULL/*{.dbg_name='GRP_3D_P_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="footswitch-pcom.2", .clk=NULL/*{.dbg_name='GRP_3D_P_CLK'}*/},
	{ .con_id="src_clk",		.dev_id="kgsl-3d0.0", .clk=NULL/*{.dbg_name='GRP_3D_CLK'}*/},
	{ .con_id="src_clk",		.dev_id="footswitch-pcom.2", .clk=NULL/*{.dbg_name='GRP_3D_CLK'}*/},
	{ .con_id="mem_clk",		.dev_id="kgsl-3d0.0", .clk=NULL/*{.dbg_name='IMEM_CLK'}*/},
	{ .con_id="lcdc_clk",		.dev_id="lcdc.0", .clk=NULL/*{.dbg_name='MDP_LCDC_PAD_PCLK_CLK'}*/},
	{ .con_id="mdp_clk",		.dev_id="lcdc.0", .clk=NULL/*{.dbg_name='MDP_LCDC_PCLK_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="mdp.0", .clk=NULL/*{.dbg_name='MDP_P_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="footswitch-pcom.4", .clk=NULL/*{.dbg_name='MDP_P_CLK'}*/},
	{ .con_id="vsync_clk",		.dev_id="mdp.0", .clk=NULL/*{.dbg_name='MDP_VSYNC_CLK'}*/},
	{ .con_id="ref_clk",		.dev_id="msm_tsif.0", .clk=NULL/*{.dbg_name='TSIF_REF_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_tsif.0", .clk=NULL/*{.dbg_name='TSIF_P_CLK'}*/},
	{ .con_id="src_clk",		.dev_id="dtv.0", .clk=NULL/*{.dbg_name='TV_ENC_CLK'}*/},
	{ .con_id="tv_dac_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='TV_DAC_CLK'}*/},
	{ .con_id="tv_enc_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='TV_ENC_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_mddi.1", .clk=NULL/*{.dbg_name='EMDH_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_mddi.1", .clk=NULL/*{.dbg_name='EMDH_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_i2c.0", .clk=NULL/*{.dbg_name='I2C_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_i2c.2", .clk=NULL/*{.dbg_name='I2C_2_CLK'}*/},
	{ .con_id="mdc_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='MDC_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="mddi.0", .clk=NULL/*{.dbg_name='PMDH_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="mddi.0", .clk=NULL/*{.dbg_name='PMDH_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_sdcc.1", .clk=NULL/*{.dbg_name='SDC1_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_sdcc.1", .clk=NULL/*{.dbg_name='SDC1_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_sdcc.2", .clk=NULL/*{.dbg_name='SDC2_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_sdcc.2", .clk=NULL/*{.dbg_name='SDC2_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_sdcc.3", .clk=NULL/*{.dbg_name='SDC3_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_sdcc.3", .clk=NULL/*{.dbg_name='SDC3_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_sdcc.4", .clk=NULL/*{.dbg_name='SDC4_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_sdcc.4", .clk=NULL/*{.dbg_name='SDC4_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_serial.1", .clk=NULL/*{.dbg_name='UART2_CLK'}*/},
	{ .con_id="alt_core_clk",	.dev_id="msm_hsusb_host.0", .clk=NULL/*{.dbg_name='USB_HS2_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_hsusb_host.0", .clk=NULL/*{.dbg_name='USB_HS2_CORE_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_hsusb_host.0", .clk=NULL/*{.dbg_name='USB_HS2_P_CLK'}*/},
	{ .con_id="alt_core_clk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='USB_HS3_CLK'}*/},
	{ .con_id="core_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='USB_HS3_CORE_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='USB_HS3_P_CLK'}*/},
	{ .con_id="core",		.dev_id="i2c_qup.4", .clk=NULL/*{.dbg_name='QUP_I2C_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="spi_qsd.0", .clk=NULL/*{.dbg_name='SPI_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="spi_qsd.0", .clk=NULL/*{.dbg_name='SPI_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_serial.0", .clk=NULL/*{.dbg_name='UART1_CLK'}*/},
	{ .con_id="uartdm_clk",		.dev_id="msm_serial_hs.0", .clk=NULL/*{.dbg_name='UART1DM_CLK'}*/},
	{ .con_id="alt_core_clk",	.dev_id="msm_otg", .clk=NULL/*{.dbg_name='USB_HS_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_otg", .clk=NULL/*{.dbg_name='USB_HS_CORE_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_otg", .clk=NULL/*{.dbg_name='USB_HS_P_CLK'}*/},
	{ .con_id="cam_m_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='CAM_M_CLK'}*/},
	{ .con_id="camif_pad_pclk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='CAMIF_PAD_P_CLK'}*/},
	{ .con_id="iface",		.dev_id="i2c_qup.4", .clk=NULL/*{.dbg_name='CAMIF_PAD_P_CLK'}*/},
	{ .con_id="csi_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='CSI0_CLK'}*/},
	{ .con_id="csi_vfe_clk",	.dev_id=NULL, .clk=NULL/*{.dbg_name='CSI0_VFE_CLK'}*/},
	{ .con_id="csi_pclk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='CSI0_P_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="mdp.0", .clk=NULL/*{.dbg_name='MDP_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="footswitch-pcom.4", .clk=NULL/*{.dbg_name='MDP_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_vidc.0", .clk=NULL/*{.dbg_name='MFC_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="footswitch-pcom.5", .clk=NULL/*{.dbg_name='MFC_CLK'}*/},
	{ .con_id="core_div2_clk",	.dev_id="msm_vidc.0", .clk=NULL/*{.dbg_name='MFC_DIV2_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_vidc.0", .clk=NULL/*{.dbg_name='MFC_P_CLK'}*/},
	{ .con_id="iface_clk",		.dev_id="footswitch-pcom.5", .clk=NULL/*{.dbg_name='MFC_P_CLK'}*/},
	{ .con_id="vpe_clk",		.dev_id=NULL, .clk=NULL/*{.dbg_name='VPE_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="footswitch-pcom.9", .clk=NULL/*{.dbg_name='VPE_CLK'}*/},
	{ .con_id="core_clk",		.dev_id="msm_dmov", .clk=NULL/*{.dbg_name='adm_clk'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_dmov", .clk=NULL/*{.dbg_name='adm_p_clk'}*/},
	{ .con_id="core_clk",		.dev_id="qce.0", .clk=NULL/*{.dbg_name='ce_clk'}*/},
	{ .con_id="core_clk",		.dev_id="crypto.0", .clk=NULL/*{.dbg_name='ce_clk'}*/},
	{ .con_id="core_clk",		.dev_id="msm_rotator.0", .clk=NULL/*{.dbg_name='axi_rotator_clk'}*/},
	{ .con_id="core_clk",		.dev_id="footswitch-pcom.6", .clk=NULL/*{.dbg_name='axi_rotator_clk'}*/},
	{ .con_id="mem_clk",		.dev_id="msm_rotator.0", .clk=NULL/*{.dbg_name='rotator_imem_clk'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_rotator.0", .clk=NULL/*{.dbg_name='rotator_p_clk'}*/},
	{ .con_id="iface_clk",		.dev_id="footswitch-pcom.6", .clk=NULL/*{.dbg_name='rotator_p_clk'}*/},
	{ .con_id="iface_clk",		.dev_id="msm_serial_hs.0", .clk=NULL/*{.dbg_name='uart1dm_p_clk'}*/},
};
